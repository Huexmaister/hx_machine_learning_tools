...
class HxRandomForestClassifier(HxMachineLearningBaseModel):
    ...
    def __init__(self,
        ...
        :param bins:
        """
        super().__init__(data_dict, hiperparams, "RFclassifier", id_col_name, save_path)
        ...
        self.class_name: str = f"HxRandomForestClassifier"
