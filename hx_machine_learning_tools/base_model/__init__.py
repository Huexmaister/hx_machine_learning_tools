...
class HxMachineLearningBaseModel(ABC):
    def __init__(self, data_dict: Dict[str, pd.DataFrame], hiperparams: dict, model_name: str, id_col_name: str | None, save_path: str | None = None):
        """
        ...
        :param id_col_name: Columna de ID si existe
        """
        super().__init__()
        ...
        # ---- 2.2: Almaceno la columna de ID (si existe) en la propiedad
        self.id_col_name: str | None = id_col_name
