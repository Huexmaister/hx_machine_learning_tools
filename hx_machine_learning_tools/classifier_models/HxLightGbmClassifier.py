...
class HxLightGbmClassifier(HxMachineLearningBaseModel):
    ...
    def __init__(self,
        ...
        :param bins:
        """
        super().__init__(data_dict, hiperparams, "LGBMclassifier", id_col_name, save_path)
        ...
        self.class_name: str = f"HxLightGbmClassifier"
